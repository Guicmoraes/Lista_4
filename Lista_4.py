import math
#1.Hierarquia de Figuras Geométricas
...
per_r = r1.calcular_perimetro()

area_r = r1.calcular_area()

print('perímetro do retângulo: ',per_r,"\nÁrea do retângulo: ",area_r)
...
per_t = t1.calcular_perimetro()
area_t = t1.calcular_area()

print('Perímetro do triângulo: ',per_t,'\nÁrea do triângulo: ',area_t)
...
c1_circun = c1.calcular_circunferência()

print('Área do círculo: ',c1_area,'\nCircunferência do círculo: ',c1_circun)
